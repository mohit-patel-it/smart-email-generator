...
//            Here we can used Object Mapper they used in JSON data in extract form of Objects
    ...
    private String buildPrompt(EmailRequest emailRequest) {
        ...
        prompt.append("Generate a professional email reply for the following email content and Best regard name Mohit Patel. ");
        prompt.append("Please do not generate a subject line Make a concise content. ");
